ERROR_MESSAGES = {
    ...
    10072: "Неверная пара API-ключей. Проверьте ключи в /set_keys.",
    ...
    -2013: "Ордер не существует. Возможно, он был отменен или исполнен.",
    ...
    700007: "Нет разрешения на доступ к API. Проверьте список доверенных IP и параметры API",
